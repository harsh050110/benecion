  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid md:grid-cols-3 gap-10">
      ...
      <Link to="/OutdoorStandeeP25" className="h-full w-full group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition overflow-hidden">
        <img src={p6Img} alt="Outdoor LED Video Display P-2.5" className="h-64 w-full object-contain  group-hover:scale-105 transition duration-500" />
        <div className="p-6 text-center font-semibold">
      ...
      <section className="bg-white py-24 px-6">
        ...
        <div className="mt-20 text-center">
          <p className="text-lg font-semibold text-gray-800">
           <span className="text-blue-600"> Beneicon</span> — TRUST <span className="text-blue-700">TECHNOLOGY </span> IMPACT.
          </p>
        </div>
