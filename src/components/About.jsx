const AboutSection = () => {
  return (
    <section className="bg-[#F4F2F3]  text-gray-900 py-24 px-6">
      <div className="max-w-7xl mx-auto">

        {/* Section Heading */}
        <div className="text-center mb-20">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-blue-700">
            Welcome to Beneicon
          </h2>
        ...
        {/* Why Choose Us */}
        <div>
          <h3 className="text-3xl font-bold text-blue-700 text-center mb-16">
            Why Choose Beneicon?
          </h3>
